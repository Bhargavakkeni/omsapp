...
urlpatterns=[
    ...
    path('omsadmin',views.omsadmin,name='omsadmin'), #url for displaying a CRUD application when login is successful
    path('show',views.show,name='show'), #url to display records of the user's(omsadmin) orders
    path('add',views.add,name='add'),    #url to add new records in to omsadmin database
    path('update',views.update,name='update'),  #url to update the specified fields in omsadmin database
    path('delete',views.delete,name='delete'),  #url to delete the specified record in omsadmin database
